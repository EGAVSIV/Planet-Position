...
("पुनर्वसु","बृहस्पति"),("पुष्‍य","शनि"),("आश्लेषा","बुध"),
...
COL = {"सूर्य":"#FFC06B","चन्द्र":"#CFE9FF","मंगल":"#FF8A8A",
...
def drawer(pos):
    ...
    f  = pygame.freetype.Font(FONT,32)
    ...
    for name,code,sym in PLANETS:
        ...
        pygame.draw.circle(surf,pygame.Color(COL[name]),(int(x),int(y)),28)
        f.render_to(surf,(x-14,y-20),sym,(0,0,0))

        f2.render_to(surf,(x-45,y+35),nakshatra(lon),(255,230,200))
